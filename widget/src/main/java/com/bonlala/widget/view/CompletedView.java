...
//属性
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        mRingColor = Color.RED;
        mRingBgColor = Color.parseColor("#FFEBEBEB");
//
...
//
//        mCircleColor = typeArray.getColor(R.styleable.CompletedView_circleColor_color, 0xFFFFFFFF);
//
...
//外圆弧
        ...
        if (mProgress > 0) {
            ...
            if (sweepGradient == null) {
                ...
                int[] arcColors = new int[]{Color.parseColor("#FF88FF4D"), Color.parseColor("#FF3FD58A"),Color.parseColor("#FF88FF4D")};

                float[] arcPostion = new float[]{0.0f,0.5f, 0.8f};
