...
public final class ClearEditText extends RegexEditText
    ...
    private OnInputAfterListener onInputAfterListener;

    public void setOnInputAfterListener(OnInputAfterListener onInputAfterListener) {
        this.onInputAfterListener = onInputAfterListener;
    }
    ...
    public void afterTextChanged(Editable s) {
        if(onInputAfterListener != null)
            onInputAfterListener.afterTextChanged(s);
    }


    public interface OnInputAfterListener{
        void afterTextChanged(Editable d);
    }
}